...
public class UserLoginWithOtpCommandHandler : IRequestHandler<UserLoginWithOtpCommand, AuthResultDto>
{
    ...
    public async Task<AuthResultDto> Handle(UserLoginWithOtpCommand request, CancellationToken cancellationToken)
    {
        ...
        {
            throw new UnauthorizedAccessException("Invalid phone number or OTP code");
        }
